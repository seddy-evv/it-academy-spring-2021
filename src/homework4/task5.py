# According to the initial data, the function prints in the first line the number of languages
# that all students know. Starting from the second line, there is a list of such languages.
# Then - the number of languages that at least one student knows, on the next lines -
# a list of such languages.
